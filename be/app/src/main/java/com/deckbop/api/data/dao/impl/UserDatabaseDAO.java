...
import com.deckbop.api.data.dao.rowmapper.UpdateUserRowMapper;
import com.deckbop.api.data.dao.rowmapper.UserRowMapper;
...
public class UserDatabaseDAO extends DatabaseDAO implements IUserDatasource {
    ...
    public UpdateUserResponse updateUserUsername(String username, long user_id) {
        return this.jdbcTemplate.queryForObject(SQLTemplates.updateUserUsername, new UpdateUserRowMapper(), username, user_id);
    }

    @Override
    public UpdateUserResponse updateUserEmail(String email, long user_id) {
        return this.jdbcTemplate.queryForObject(SQLTemplates.updateUserEmail, new UpdateUserRowMapper(), email, user_id);
    }

    @Override
    public UpdateUserResponse updateUserPassword(String password, long user_id) {
        return this.jdbcTemplate.queryForObject(SQLTemplates.updateUserPassword, new UpdateUserRowMapper(), password, user_id);
    }
